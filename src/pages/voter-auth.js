            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {step === 1 && (
                <>
                  ...
                  <button
                    type="submit"
                    className="w-full px-6 py-3 bg-gradient-to-r from-sky-500 to-blue-600 text-white rounded-xl font-medium hover:shadow-lg transition-all"
                  >
              ...
              {step === 2 && (
                <>
                  <div className="text-center mb-6">
                    ...
                    <h3 className="text-xl font-semibold text-blue-900 mb-2">Verify Your Phone</h3>
                    <p className="text-blue-600">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="000000"
                      maxLength="6"
                      className="w-full px-4 py-3 rounded-xl border border-blue-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all text-center text-2xl tracking-widest"
                      required
                    />
                  </div>

                  <div className="text-center">
                    <p className="text-sm text-blue-600 mb-2">Didn't receive the code?</p>
                    <button
                      type="button"
                      onClick={resendOTP}
