...
export default function CandidateProfile() {
  ...
  const [candidate, setCandidate] = useState({
    ...
    bio: "Experienced public servant with 15 years in local government. Focused on sustainable development, education, and community welfare.",
    manifesto: "My vision for Springfield includes sustainable urban development, improved public transportation, enhanced educational opportunities, and economic growth that benefits all residents. I believe in transparent governance and community engagement.",
    experience: [
      {
        title: "City Council Member",
        organization: "Springfield City Council",
        period: "2015-2023",
        description: "Led initiatives in urban planning and community development"
      },
      {
        title: "Community Development Director", 
        organization: "Springfield Development Authority",
        period: "2010-2015",
        description: "Oversaw housing projects and neighborhood revitalization programs"
      },
      {
        title: "Public Relations Manager",
        organization: "Metro Public Affairs",
        period: "2005-2010", 
        description: "Managed communications for local government initiatives"
      }
    ],
    education: [
      {
    ...
    achievements: [
      "Implemented green energy initiative that reduced city carbon footprint by 25%",
      "Reduced city budget deficit by 15% through efficient resource allocation",
      "Launched affordable housing program providing homes to 500+ families",
      "Established community health centers in underserved areas",
      "Created youth employment program with 80% job placement rate"
    ],
    socialMedia: {
      twitter: "@sarahjohnson",
      facebook: "SarahJohnsonForMayor",
      linkedin: "sarah-johnson-public-service"
    }
  });
  ...
  const PublicProfileModal = () => (
    <div className={`fixed inset-0 z-50 ${showPublicProfile ? 'block' : 'hidden'}`}>
      ...
      <div className="absolute inset-4 md:inset-8 lg:inset-16 bg-white rounded-3xl shadow-2xl overflow-hidden">
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-6">
                ...
                <button 
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg hover:shadow-lg transition-all duration-200"
                >
                  View Public Profile
                </button>
              </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 mb-8">
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex-shrink-0">
                <div className="relative">
                  <div className="w-40 h-40 bg-gradient-to-br from-blue-400 via-purple-500 to-indigo-600 rounded-3xl flex items-center justify-center shadow-2xl">
                    <svg className="w-20 h-20 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                  </div>
                  <button className="absolute -bottom-2 -right-2 w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center hover:shadow-xl transition-shadow">
              ...
              <div className="flex-1">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-6">
                  ...
                  <div className="flex gap-3">
                    <button 
                      ...
                      className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all duration-200"
                    >
                ...
                <p className="text-gray-600 leading-relaxed text-lg mb-6">{candidate.bio}</p>
          ...
          {/* Tab Navigation */}
          <div className="flex gap-2 mb-8 bg-white/60 backdrop-blur-xl rounded-2xl p-2 shadow-xl border border-white/20">
            {[
